...
class ParallaxScrollView extends Component {
  ...
  render() {
    ...
    const foreground = this._renderForeground({ fadeOutForeground, backgroundScrollSpeed, parallaxHeaderHeight, stickyHeaderHeight, renderForeground: renderForeground || renderParallaxHeader });
  ...
  _renderForeground({ fadeOutForeground, backgroundScrollSpeed, parallaxHeaderHeight, stickyHeaderHeight, renderForeground }) {
    const { scrollY,viewHeight } = this.state;
    const p = pivotPoint(parallaxHeaderHeight, stickyHeaderHeight);
    return (
